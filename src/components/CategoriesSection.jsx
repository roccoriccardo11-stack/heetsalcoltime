          ...
          {categories.map((cat, index) => {
            ...
            return (
              <div
                ...
                className={`group relative rounded-3xl overflow-hidden cursor-pointer bg-alpine-900 border border-cyan-500/20 hover:border-cyan-400/60 transition-all duration-500 shadow-card hover:shadow-glow-cyan flex flex-col justify-between min-h-[320px] ${
                ...
                <div className="relative z-10 p-6 sm:p-8 space-y-3">
                  <div className="flex items-end justify-between gap-4">
                    <div>
                      ...
                      <p className="text-xs sm:text-sm text-zinc-300 line-clamp-2 mt-1 leading-relaxed max-w-xl">
                        {cat.shortDesc}
                      </p>
                    </div>

                    <div className="w-10 h-10 rounded-full bg-alpine-800/80 border border-cyan-500/30 group-hover:bg-gradient-to-r group-hover:from-cyan-400 group-hover:to-blue-600 group-hover:border-cyan-300 group-hover:text-black text-white flex items-center justify-center flex-shrink-0 transition-all duration-300 group-hover:scale-110 shadow-md group-hover:shadow-glow-cyan">
